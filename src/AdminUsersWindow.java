...
public class AdminUsersWindow extends JFrame {
    ...
    private void addUser() {
        ...
        if (JOptionPane.showConfirmDialog(this, msg, "Add User",
    ...
    private void editUser() {
        ...
        Object[] msg = { "Email:", emailF, "New Password (leave blank to keep current):", passF, "Role:", roleB,
                "First Name:", firstF, "Last Name:", lastF };

        if (JOptionPane.showConfirmDialog(this, msg, "Edit User",
                JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
            try {
                service.updateUser(id, emailF.getText(), new String(passF.getPassword()),
                        (String) roleB.getSelectedItem(), firstF.getText(), lastF.getText());
                loadData();
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Error: " + ex.getMessage());
